      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 sm:py-32">
          <div className="text-center space-y-8">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mt-6" data-testid="hero-title">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <Card className="bg-slate-900/50 backdrop-blur-lg border-slate-700/50 hover:border-emerald-500/50 transition-all" data-testid="stat-card-return">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-slate-400 mt-1">Avg Daily Return</p>
                </CardContent>
              </Card>
